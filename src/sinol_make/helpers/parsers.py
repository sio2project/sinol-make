...
def add_compilation_arguments(parser: argparse.ArgumentParser, custom_sanitize_help=""):
    ...
    parser.add_argument('--sanitize', dest='sanitize', choices=['no', 'simple', 'full'], default='no',
...
def add_overwrite_argument(parser: argparse.ArgumentParser):
    parser.add_argument('--overwrite', default=False, action='store_true',
                        help='overwrite output files which were not generated by sinol-make '
                             '(for example hand-written ones) instead of verifying them')

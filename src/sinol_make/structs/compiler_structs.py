...
class Compilers:
    ...
    def __init__(self, c_compiler_path: str = None, cpp_compiler_path: str = None, cpp_standard: str = None,
        ...
        self.cpp_standard = compiler.get_cpp_standard(self.cpp_compiler_path)

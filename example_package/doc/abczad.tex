...
% \tNoSkipSection{text} % Jak wyżej, tylko bez odstępu między akapitem wyżej
...
% \makestandardexample{id}  % obok siebie i pod sobą
...
W pierwszym wierszu wejścia znajduje się jedna liczba $\tc{n}$ ($1\leq \tc{n}\leq 1\ 000\ 000$), oznaczająca parametr z~wejścia.
...
\makecompactexample{a}  % abc0.in -> {}, abc0x.in -> {x}
\makecompactexample{b}

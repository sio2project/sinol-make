...
def test_flag_tests(capsys, create_package):
    ...
    with pytest.raises(SystemExit) as e:
        run(["inwer", "prog/werinwer.cpp", "--tests", "in/wer2a.in"])
    ...
    with pytest.raises(SystemExit) as e:
        run(["inwer", "prog/werinwer2.cpp", "--tests", "in/wer2a.in", "in/wer1a.in"])
